...
def add_project(db, airport, runway, **kwargs):
    existing = db.scalar(
        select(Project).where(
            Project.airport_id == airport.id,
            Project.title == kwargs["title"],
        )
    )
    if existing:
        return existing
    project = Project(airport=airport, runway=runway, **kwargs)
    db.add(project)
    db.flush()
    return project
...
def seed():
    ...
    try:
        ...
        project_rows = [
            dict(code="ASE", title="Runway 15/33 future EMAS at both runway ends", project_type="new_installation",
                 status="alp", confidence_level="planned", planning_year=2027, procurement_year=None,
                 ...
                 description="Two EMAS beds are shown in Aspen's adopted future airport layout concept.",
            ...
            dict(code="MHT", title="Runway 6 departure-end EMAS replacement", project_type="replacement",
                 status="procurement", confidence_level="confirmed", planning_year=2026, procurement_year=2026,
                 ...
                 description="Replacement of existing EMAS, pavement and related airfield work.",
            ...
            dict(code="BOS", title="Runway 9/27 RSA and EMAS phase 2", project_type="new_installation",
                 status="construction", confidence_level="confirmed", planning_year=2026, procurement_year=2025,
                 ...
                 description="Continuation of runway safety area and EMAS construction.",
            ...
            dict(code="SFO", title="Runway 1R/19L EMAS seam replacement", project_type="maintenance",
                 status="construction", confidence_level="confirmed", planning_year=2026, procurement_year=2026,
                 estimated_total_value_usd=None, estimated_emas_value_usd=None, probability_score=10.0,
                 likely_supplier=None, supplier_reason=None,
                 description="Seam replacement and maintenance in existing EMAS system.",
                 source_title="FAA Airport Construction Impact Report", source_url="https://www.faa.gov/",
                 source_type="FAA", publisher="FAA", source_date=date(2026, 7, 1)),
            dict(code="FTY", title="Runway 8/26 EMAS safety improvements", project_type="new_installation",
                 status="design", confidence_level="programmed", planning_year=2026, procurement_year=2026,
                 ...
                 description="Runway safety improvements with planned EMAS at both ends.",
            ...
            dict(code="BGM", title="Runway 16 departure EMAS project", project_type="new_installation",
                 status="funded", confidence_level="programmed", planning_year=2026, procurement_year=None,
                 estimated_total_value_usd=None, estimated_emas_value_usd=None, probability_score=8.5,
                 likely_supplier="Runway Safe", supplier_reason="County capital plan includes EMAS-related project phases.",
                 description="Capital program includes EMAS work and final flight-check phase.",
            ...
            dict(code="CRQ", title="Runway 24 EMAS improvement", project_type="new_installation",
                 status="cip", confidence_level="programmed", planning_year=2027, procurement_year=None,
                 ...
                 description="Programmed EMAS project for Runway 24.",
            ...
            dict(code="STP", title="Runway 14/32 EMAS replacement at both ends", project_type="replacement",
                 status="cip", confidence_level="programmed", planning_year=2027, procurement_year=None,
                 ...
                 description="Planned replacement of two existing EMAS beds.",
            ...
            dict(code="JFK", title="Runway 22L departure-end EMAS replacement", project_type="replacement",
                 status="design", confidence_level="programmed", planning_year=2028, procurement_year=None,
                 ...
                 description="Replacement planning for EMAS installed in 2007.",
            ...
            dict(code="HYA", title="EMAS reconstruction", project_type="replacement",
                 status="environmental_review", confidence_level="planned", planning_year=2027, procurement_year=None,
                 ...
                 description="Future EMAS reconstruction described in environmental documentation.",
            ...
            dict(code="MKC", title="Existing EMAS lifecycle and replacement study", project_type="study",
                 status="master_plan", confidence_level="planned", planning_year=2026, procurement_year=None,
                 ...
                 description="Lifecycle study for repair or replacement of existing EMAS.",
            ...
            dict(code="MDW", title="Future EMAS lifecycle watch", project_type="replacement_watch",
                 status="identified", confidence_level="speculative", planning_year=None, procurement_year=None,
                 ...
                 description="Watch item only. No verified current procurement or capital project.",
        ...
        for row in project_rows:
            ...
            project = add_project(db, airports[code], runways[code], **row)
